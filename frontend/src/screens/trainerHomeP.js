...
import { tainerProfileUpdate } from '../utils/api';



const TrainerHomeP = () => {
  const [open, setOpen] = useState(false);
  const data = useSelector(store=>store?.user?.userData?.user)
...
const handleChange = (event) => {
  ...
  const submit = (e) =>{
    console.log("qeacfcsghcvguj");
    e.preventDefault()
    tainerProfileUpdate(userData)
